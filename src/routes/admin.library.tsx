...
import { BookOpen, Plus, X, Search, ArrowDownUp, BookMarked, Clock, Download } from "lucide-react";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-8">
            <Panel title="E-Book Catalog">
              ...
              <div className="md:hidden space-y-3">
                {ebooks.map((e) => (
                  <div key={e._id} className="rounded-lg border border-border p-3 flex justify-between items-center">
                    <div>
